    ...
    return (
      <div className="relative bg-section">
        <div className="mx-auto md:flex max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
          <div className="px-6 pb-24 sm:pt-8 xs:pt-16 md:pt-28 sm:pb-16  lg:col-span-7 lg:px-0 lg:pb-56 lg:pt-24 xl:col-span-6">
            <div className="mx-auto xl:max-w-md max-w-2xl  lg:mx-0">        
                <p className="mt-6 text-lg leading-8 text-gray-600">
                    Take a trip to California
                </p>
              <h1 className="mt-24 text-5xl xs:text-2xl md:text-3xl xl:text-4xl font-bold tracking-tight text-gray-900 xs:mt-4">
          ...
          <div className="bg-white md:absolute xs:relative xs:bottom-32 sm:bottom-48 md:bottom-8 sm:block md:flex xs:w-90 md:w-full xl:w-94 xxl:w-85 2xl:w-63 3xl:w-47 rounded-lg xs:left-5 md:left-auto">
            <div className="sm:p-2 p-4 xs:w-full w-1/4 md:border-r-2">
            ...
            <div className="sm:p-2 p-4 xs:w-full w-1/4 md:border-r-2">
                <div className="flex sm:p-2">           
                    ...
                    <p className="px-4 font-xs font-semibold">Cruises</p>
                </div>
                <div className="flex sm:p-2">
                    <FontAwesomeIcon icon={faHeadphones} style={{color: "#2639e2",}} />
                    <p className="px-4 font-xs font-semibold">Shows </p>
                </div>            
            ...
            <div className="flex sm:p-2">            
                ...
                <p className="px-4 font-xs font-semibold">Food & Drink</p>
            </div>            
            <div className="flex sm:p-2">
                <FontAwesomeIcon icon={faWorm} style={{color: "#2639e2",}} />
                <p className="px-4 font-xs font-semibold">Tours & Trips</p>
            </div>
                
                
            </div>
            <div className="sm:p-2 p-4 xs:w-full w-1/4">
            
            <div className="flex sm:p-2">
                <FontAwesomeIcon icon={faCalendarDays} style={{color: "#2639e2",}} />
                <p className="px-4 font-xs font-semibold">History</p>
            </div>
            <div className="flex sm:p-2">
                <FontAwesomeIcon icon={faComments} style={{color: "#2639e2",}} />
                <p className="px-4 font-xs font-semibold">Workshops</p>
            </div>            
            </div>
          </div>
        </div>       
