...
import calisightlogo from '@/assets/images/cali-sight-logo.png'
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            ...
            <Image className="" src={calisightlogo} width={120} height={100} alt="" />
          </a>
        </div>
        ...
        Post your Listing
          ...
          <Popover className="relative">
            ...
            >
              <Popover.Panel className="absolute  top-full z-10 mt-3 w-screen max-w-[12rem] overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-gray-900/5">
                <div className="p-4">
                  {Attractions.map((Attraction) => (
                    ...
                    >
                      ...
                      <div className="flex-auto">
                        <a href={Attraction.href} className="block font-semibold text-gray-900">
                          {Attraction.name}
